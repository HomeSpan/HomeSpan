...
* [HomeSpan SpanPoint](https://github.com/HomeSpan/HomeSpan/blob/dev/docs/NOW.md) - facilitates point-to-point, bi-directional communication between ESP32 Devices using ESP-NOW
